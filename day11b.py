...
def solve(lines):
    ...
    # this is the hack, check with this value instead of different divisors
    common_denominator = 1 * 11 * 19 * 5 * 3 * 13 * 17 * 7 * 2
    ...
    def monkey_business(monkey_lines):
        ...
        def round(all_monkeys):
            ...
            for item in current_items:
                ...
                # check with common common_denominator instead!
